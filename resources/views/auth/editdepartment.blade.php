                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('updatedepartment')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="common-input mt-0" id="name" name="name" value="{{$departments->name}}">
                        </div>
                        <input type="text" name="id" value="{{$departments->id}}" hidden>
                        <button type="submit" class="primary-btn hover d-inline-flex align-items-center"><span
                                class="mr-10">update</span><span class="lnr lnr-arrow-right"></span></button>
